...
# Detect C, C++, AR, Ranlib applications
...
if (CMAKE_GENERATOR MATCHES "Xcode")
    # this works only in Xcode generator but gives configuration errors in GNU Makefiles
    set(CMAKE_MACOSX_BUNDLE YES)
    set(CMAKE_XCODE_ATTRIBUTE_CODE_SIGNING_REQUIRED "NO")
else()
    # This is useless in Xcode
    # Force -isysroot option to avoid clang to use OS X frameworks
    set (CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -isysroot ${CMAKE_OSX_SYSROOT}" CACHE STRING "" FORCE)
    set (CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -isysroot ${CMAKE_OSX_SYSROOT}" CACHE STRING "" FORCE)
